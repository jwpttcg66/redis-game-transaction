...
import com.redis.transaction.service.RedisClusterService;
...
public class ClusterTest {
    public static void main(String[] args) {
        ...
        RedisClusterService redisClusterService = (RedisClusterService) BeanUtil.getBean("redisClusterService");
        TransactionService transactionService = (TransactionService) BeanUtil.getBean("transactionService");

        String union = "union";
        TestMutexEntity testMutexEntity = GameTransactionEntityFactoryImpl.createTestMutexEntity(GameTransactionEntityCauseImpl.test, redisClusterService, RedisKey.player, union);
