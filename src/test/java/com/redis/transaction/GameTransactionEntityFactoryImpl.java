...
public class GameTransactionEntityFactoryImpl extends GameTransactionEntityFactory {
    ...
    public  static TestMutexEntity createTestMutexEntity(GameTransactionEntityCause cause,IRedisService redisService, String redisKey, String union){
    ...
    public  static ForceEntity createForceEntity(GameTransactionEntityCause cause,IRedisService redisService, String redisKey, String union, int seconds){
        String key = GameTransactionKeyFactoryImpl.getPlayerTransactionEntityKey(cause, redisKey, union);
        ForceEntity forceEntity = new ForceEntity(cause, union, redisService, GameTransactionLockType.FORCE_WRITE_TIME, seconds);
        return forceEntity;
    }

    public  static TestTimeMutexEntity createTestTimeMutexEntity(GameTransactionEntityCause cause,IRedisService redisService, String redisKey, String union){
        String key = GameTransactionKeyFactoryImpl.getPlayerTransactionEntityKey(cause, redisKey, union);
        TestTimeMutexEntity testTimeMutexEntity = new TestTimeMutexEntity(cause, union, redisService);
        return testTimeMutexEntity;
    }

    public  static WaitMutexEntity createWaitMutexEntity(GameTransactionEntityCause cause,IRedisService redisService, String redisKey, String union){
        String key = GameTransactionKeyFactoryImpl.getPlayerTransactionEntityKey(cause, redisKey, union);
        WaitMutexEntity waitTimeMutexEntity = new WaitMutexEntity(cause, union, redisService);
        return waitTimeMutexEntity;
    }

    public  static RollbackMutexEntity createRollbackMutexEntityy(GameTransactionEntityCause cause,IRedisService redisService, String redisKey, String union){
        String key = GameTransactionKeyFactoryImpl.getPlayerTransactionEntityKey(cause, redisKey, union);
